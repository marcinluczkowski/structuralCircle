...
{
    public class CreateDemandBank_FromMaterialList : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("DemandBank", "DB",  "Demand Bank built from CSV",          GH_ParamAccess.item);
        ...
        static string BuildReport(DemandBank bank, string filePath)
        {
            ...
            sb.AppendLine($"Demand Bank from: {Path.GetFileName(filePath)}");
        ...
        public override Guid ComponentGuid => new Guid("A1B2C3D4-1111-4000-8000-000000000021");
    }
}
