...
demand = pd.DataFrame(columns = ['Length', 'Area', 'Inertia_moment', 'Height', 'Latitude', 'Longitude'])
supply = pd.DataFrame(columns = ['Length', 'Area', 'Inertia_moment', 'Height', 'Is_new', 'Latitude', 'Longitude'])

# Add a perfect matching pair
demand.loc['D1'] = {'Material': 1, 'Length': 7.00, 'Area': 0.04, 'Inertia_moment':0.00013, 'Height': 0.20, 'Latitude': "63.415867", 'Longitude': "10.408174"}
supply.loc['R1'] = {'Material': 1, 'Length': 7.00, 'Area': 0.04, 'Inertia_moment':0.00013, 'Height': 0.20, 'Is_new':False, 'Latitude': "60.789693", 'Longitude': "10.682182"}
...
demand.loc['D2'] = {'Material': 1, 'Length': 13.00, 'Area': 0.02, 'Inertia_moment':0.00001, 'Height': 0.05, 'Latitude': "63.415867", 'Longitude': "10.408174"}

# Add non-matchable supply
# supply.loc['R2'] = {'Material': 1, 'Length': 0.1, 'Area': 0.04, 'Inertia_moment':0.00013, 'Height': 0.20, 'Is_new':False}
supply.loc['R2'] = {'Material': 1, 'Length': 1.2, 'Area': 0.04, 'Inertia_moment':0.00013, 'Height': 0.20, 'Is_new':False, 'Latitude': "60.789693", 'Longitude': "10.682182"}

# Add element with two good matches, where second slighlty better
demand.loc['D3'] = {'Material': 1, 'Length': 5.00, 'Area': 0.04, 'Inertia_moment':0.00013, 'Height': 0.20, 'Latitude': "63.415867", 'Longitude': "10.408174"}
supply.loc['R3'] = {'Material': 1, 'Length': 5.20, 'Area': 0.042, 'Inertia_moment':0.00015, 'Height': 0.22, 'Is_new':False, 'Latitude': "60.789693", 'Longitude': "10.682182"}
supply.loc['R4'] = {'Material': 1, 'Length': 5.10, 'Area': 0.041, 'Inertia_moment':0.00014, 'Height': 0.21, 'Is_new':False, 'Latitude': "60.789693", 'Longitude': "10.682182"}

# Add element with much bigger match
demand.loc['D4'] = {'Material': 1, 'Length': 8.00, 'Area': 0.1, 'Inertia_moment':0.0005, 'Height': 0.50, 'Latitude': "63.415867", 'Longitude': "10.408174"}
supply.loc['R5'] = {'Material': 1, 'Length': 12.00, 'Area': 0.2, 'Inertia_moment':0.0008, 'Height': 0.8, 'Is_new':False, 'Latitude': "60.789693", 'Longitude': "10.682182"}
...
demand.loc['D5'] = {'Material': 1, 'Length': 4.00, 'Area': 0.1, 'Inertia_moment':0.0005, 'Height': 0.50, 'Latitude': "63.415867", 'Longitude': "10.408174"}
