...
demand = hm.create_random_data_demand(demand_count=300, demand_lat = demand_coordinates["Latitude"], demand_lon = demand_coordinates["Longitude"],new_lat = new_coordinates["Latitude"], new_lon = new_coordinates["Longitude"], length_min = 1, length_max = 10.0, area_min = 0.15, area_max = 0.30)
supply = hm.create_random_data_supply(supply_count=300,demand_lat = demand_coordinates["Latitude"], demand_lon = demand_coordinates["Longitude"],supply_coords = supply_coords, length_min = 1, length_max = 30.0, area_min = 0.15, area_max = 0.30)
