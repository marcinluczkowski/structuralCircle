...
plot.plot_algorithm(score_dict, x_values, xlabel = "Number of elements", ylabel = "Total score [kg CO2 eq.]", title = "", fix_overlapping=True, save_filename="bipartite_results_score.png")