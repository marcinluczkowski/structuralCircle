...
constants = {
    ...
    "Demand file location": r"./CSV/DEMAND_TEST_FILL_CLOSEST.xlsx",
...
pdf = hm.generate_pdf_report(pdf_results,projectname = constants["Project name"], supply=supply,demand=demand,filepath = r"./Local_files/GUI_files/Results/")
